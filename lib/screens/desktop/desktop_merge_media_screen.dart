...
class DesktopMergeMediaScreen extends StatefulWidget {
  final VoidCallback onBack;
  final SettingsService? settingsService;
  final MergeMediaController? controller;

  const DesktopMergeMediaScreen({
    super.key,
  ...
  @override
  State<DesktopMergeMediaScreen> createState() => _DesktopMergeMediaScreenState();
}

class _DesktopMergeMediaScreenState extends State<DesktopMergeMediaScreen> with WidgetsBindingObserver {
              ...
              Row(
                ...
                children: [
                  IconButton.filledTonal(
                    ...
                    onPressed: sec > 1.0
                        ? () => setDlgState(() => sec = (sec - 1.0).clamp(1.0, 30.0))
                        : null,
                  ),
        ...
        builder: (context, _) {
          return Column(
            children: [
              ...
              // Main workspace: Preview player + Media pool top, Timeline bottom
              Expanded(
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    final workspace = Column(
                      children: [
                        // Top half: Preview player + Media pool side-by-side
                    Expanded(
                      flex: 4,
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            // Synchronized Preview Player (Left)
                            Expanded(
                              flex: 5,
                              child: _buildPreviewPlayer(isDark, theme, l10n),
                            ),
                            const SizedBox(width: 16),
                            // Added Media Pool (Right)
                            Expanded(
                              flex: 5,
                              child: _buildMediaPool(isDark, theme, l10n),
                            ),
                          ],
                        ),
                      ),
                    ...
                    // Bottom half: 3-Track Timeline
                    Expanded(
                      flex: 5,
                      child: _build3TrackTimeline(isDark, theme, l10n),
                    ),
                  ],
                );
                if (isCompact) {
  ...
  Widget _buildPreviewPlayer(bool isDark, ThemeData theme, AppLocalizations l10n) {
                  ...
                  if (!_controller.hasContent)
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                _controller.isPlaying ? 'Playing Audio Soundtrack' : 'Audio Track Ready',
                    ...
                    Image.file(
                      ...
                      errorBuilder: (_, __, ___) => activeItem.thumbnailBytes != null
                          ...
                          : const Icon(Icons.image_rounded, size: 48, color: Colors.white),
                    )
                  else if (activeItem != null && activeItem.isVideo)
                    activeItem.thumbnailBytes != null
                        ? Image.memory(activeItem.thumbnailBytes!, fit: BoxFit.contain)
                        : const Icon(Icons.movie_creation_rounded, size: 48, color: Colors.white),
  ...
  Widget _buildMediaPool(bool isDark, ThemeData theme, AppLocalizations l10n) {
    return Card(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
            ...
            child: _controller.mediaPool.isEmpty
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, idx) {
                      ...
                      return _buildDraggableMediaPoolCard(item, isDark, theme, l10n);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildDraggableMediaPoolCard(
    MergeMediaItem item,
    bool isDark,
    ThemeData theme,
                      ...
                      : (item.isAudio
                          ? Stack(
                              children: [
                                ...
                                Center(
                                  child: Icon(Icons.audiotrack_rounded, color: typeColor, size: 20),
                                ),
                              ],
                            )
  ...
  Widget _build3TrackTimeline(bool isDark, ThemeData theme, AppLocalizations l10n) {
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              _buildTimelineRuler(isDark, trackAreaWidth),
                              const Divider(height: 1, color: Color(0xFF3F444D)),

                              // Track 1: Images
                              Expanded(
                                child: _buildTrackLaneContent(
                                  trackIndex: 1,
  ...
  Widget _buildTimelineRuler(bool isDark, double trackAreaWidth) {
    final totalDur = _controller.totalDurationSec;
        ...
        child: DragTarget<Object>(
          ...
          builder: (context, candidateData, rejectedData) {
            ...
            return Container(
              ...
              child: trackIndex == 3
                  ? _buildAudioTrackContents(trackColor, isDark, l10n, trackAreaWidth)
                  : _buildVisualTrackContents(trackIndex, trackColor, isDark, l10n, trackAreaWidth),
            );
          },
        ),
      ),
  ...
  Widget _buildVisualTrackContents(
    int trackIndex,
    Color trackColor,
    bool isDark,
    AppLocalizations l10n,
  ...
  Widget _buildAudioTrackContents(
    Color trackColor,
    bool isDark,
    AppLocalizations l10n,
    double trackAreaWidth,
            ...
            child: item.thumbnailBytes != null
                ...
                : (item.isImage
                    ? Image.file(
                        File(item.path),
                        fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => Icon(Icons.image, size: 16, color: trackColor),
                      )
                    : Icon(
                        item.isVideo ? Icons.movie : Icons.audiotrack,
                        size: 16,
                        color: trackColor,
                      )),
          ),
